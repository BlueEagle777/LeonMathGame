...
for ($i = 0; $i < count($firstNumbers); $i++) {
    ...
    $sql = "INSERT INTO plus_hist (player_ID, Date, FirstNum, SecondNum, PlayerAns, Correct, Time) VALUES (?, ?, ?, ?, ?, ?, ?)";
...
$parameter = "plus"; // Set the parameter to "plus," "min," or "mul" as needed
